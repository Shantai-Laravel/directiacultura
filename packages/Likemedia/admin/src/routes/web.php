...
Route::group(['middleware' => ['web']], function ()
{
    ...
    Route::group(['namespace' => $namespace, 'prefix' => 'back', 'middleware' => 'auth'], function ()
    {
        ...
        Route::post('/product-categories/{id}/deleteImage', 'ProductCategoryController@deleteImage')->name('product-categories.deleteImage');
        ...
        Route::get('/products/{id}/{pdf}', 'ProductsController@openPdf')->name('products.pdf');
        ...
        Route::group(['prefix' => 'settings'], function ()
        {
            ...
            Route::post('/contacts/deleteSign', 'ContactController@deleteSign')->name('contacts.deleteSign');
            ...
            Route::post('/ckeditor/upload/images', 'PostsController@uploadImagesCkeditor')->name('infos.upload');
