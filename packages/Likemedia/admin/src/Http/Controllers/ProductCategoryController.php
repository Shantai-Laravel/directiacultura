...
class ProductCategoryController extends Controller
{
    ...
    private function uploadImg($file)
    {
        ...
        $image_resize->save(public_path('images/productCategories/og/' .$name), 75);

        $image_resize->resize($product_image_size[0]['bgfrom'], $product_image_size[0]['bgto'])->save('images/productCategories/bg/' .$name, 75);

        $image_resize->resize($product_image_size[1]['mdfrom'], $product_image_size[1]['mdto'])->save('images/productCategories/md/' .$name, 75);

        $image_resize->resize($product_image_size[2]['smfrom'], $product_image_size[2]['smto'])->save('images/productCategories/sm/' .$name, 85);
    ...
    public function deleteImage($id) {
        ...
        if(count($productCategory) > 0) {
            if (is_file(public_path('images/productCategories/bg/'.$productCategory->img))) {
                unlink(public_path('images/productCategories/bg/'.$productCategory->img));
            }
            if (is_file(public_path('images/productCategories/og/'.$productCategory->img))) {
                unlink(public_path('images/productCategories/og/'.$productCategory->img));
            }
            if (is_file(public_path('images/productCategories/md/'.$productCategory->img))) {
                unlink(public_path('images/productCategories/md/'.$productCategory->img));
            }
            if (is_file(public_path('images/productCategories/sm/'.$productCategory->img))) {
                unlink(public_path('images/productCategories/sm/'.$productCategory->img));
            }
