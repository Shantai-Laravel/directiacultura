                  ...
                  @if (count($generals) > 0)
                      @foreach ($generals as $general)
                          <div class="multiDataWrapp _{{ $lang->lang }}" style="display: block">
                              ...
                              <div class="form-group">
                                  <label>Title</label>
                                  <textarea  class="form-control"  name="name_{{ $lang->lang }}[]" rows="5" cols="100">{{!empty($general->translationByLanguage($lang->id)->first()) ? $general->translationByLanguage($lang->id)->first()->body : ''}}</textarea>
                              </div>
