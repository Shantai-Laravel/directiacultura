                ...
                <ul>
                    ...
                    <li>
                      ...
                      <input type="text" name="btn_text_{{ $lang->lang }}"
                          ...
                          @foreach($promotion->translations as $translation)
                          @if($translation->lang_id == $lang->id && !is_null($translation->lang_id))
                          value="{{ $translation->btn_text }}"
                          @endif
                        @endforeach>
                    </li>
                    <li>
                      <label for="btn_href_{{$lang->lang}}">Button href</label>
                      <input type="text" name="btn_href_{{ $lang->lang }}"
                          id="btn_href_{{ $lang->lang }}"
                          @foreach($promotion->translations as $translation)
                          @if($translation->lang_id == $lang->id && !is_null($translation->lang_id))
                          value="{{ $translation->btn_href }}"
                          @endif
                        @endforeach>
                    </li>
                </ul>
