        ...
        <div class="tab-content {{ $key == 0  ? ' active-content' : '' }}" id={{ $lang->lang }}>
            <div class="part left-part">
                <ul>
                    ...
                    <li>
                      <label for="btn_text_{{ $lang->lang }}">Button text  [{{ $lang->lang }}]</label>
                      <input type="text" name="btn_text_{{ $lang->lang }}" class="name"
                          id="btn_text_{{ $lang->lang }}">
                    </li>
                    <li>
                      <label for="btn_href_{{ $lang->lang }}">Button href [{{ $lang->lang }}]</label>
                      <input type="text" name="btn_href_{{ $lang->lang }}" class="name" id="btn_href_{{ $lang->lang }}"/>
                    </li>
                </ul>
            </div>
