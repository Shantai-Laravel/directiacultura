...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('product-categories.partial.save') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="tab-content {{ $key  == 0 ? ' active-content' : '' }}"
                        ...
                        <div class="part full-part">
                            <ul>
                                ...
                                <li>
                                    <label>Body [{{ $langOne->lang }}]</label>
                                    <textarea name="body_{{ $langOne->lang }}"></textarea>
                                    <script>
                                        CKEDITOR.replace('body_{{ $langOne->lang }}', {
                                            language: '{{$langOne}}',
                                        });
                                    </script>
                                </li>
