            ...
            <div class="part col-md-6">
                <li>
                    <div class="form-group text-center alert-success">
                        <label><br>
                            <input class="checkbox" type="checkbox" name="on_home" {{ $product->on_home == 1 ? 'checked' : ''}}>
        ...
        <div class="part left-part">
            ...
            <ul>
                ...
                <li>
                    <div class="col-md-6">
                        <label>Pdf</label>
                        <input type="hidden" name="pdf_old" value="{{ $product->pdf }}">
                        <input type="file" name="pdf" value="">
                    </div>
                    <div class="col-md-6">
                        @if ($product->pdf)
                          <a href="{{ route('products.pdf', [$product->id, $product->pdf]) }}" target="_blank">Open pdf file - {{ $product->pdf }}</a>
                        @endif
                    </div>
                </li>
                <li>
