       ...
       <div class="col-lg-6 col-sm-8 col-12 regBoxBorder">
         <div class="regBox">
              ...
              <div class="row">
                 <div class="col-12">
                    <div class="errorPassword">
                      <p><strong>A fost comisă o greșeală</strong></p>
            ...
            <form action="{{ url()->current() }}" method="post">
              ...
              <div class="row">
                <div class="col-md-7">
                  <input type="email" placeholder="email" name="email" style="padding: 5px;">
                  @if ($errors->has('email'))
                ...
                <div class="col-12">
                  <input class="butt" type="submit" value="Send email">
                </div>
              </div>
            </form>
         </div>
